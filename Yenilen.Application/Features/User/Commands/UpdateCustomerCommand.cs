...
public sealed class UpdateCustomerCommand:IRequest<Result<UpdateCustomerCommandResponse>>
{
...
public sealed class UpdateCustomerCommandResponse
{
        public int? UserId { get; set; }
}

public sealed class UpdateUserCommandValidator : AbstractValidator<UpdateCustomerCommand>
{
