...
internal sealed class GetUserAppointmentsByUserIdHandler:IRequestHandler<GetUserAppointmentsByUserIdQuery,IQueryable<AppointmentDto>>
{
    ...
    public Task<IQueryable<AppointmentDto>> Handle(GetUserAppointmentsByUserIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return Task.FromResult(userAppointments);
    }
}